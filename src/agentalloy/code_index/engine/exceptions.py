...
OPENAI_NO_KEY = (
    "OpenAI provider requires api_key. Set ORCHESTRATOR_API_KEY or CYPHER_API_KEY in .env file."
)
OLLAMA_NOT_RUNNING = (
    "Ollama server not responding at {endpoint}. Make sure Ollama is running: ollama serve"
)
...
MODEL_FORMAT_INVALID = "Model must be specified as 'provider:model' (e.g., openai:gpt-4o)."
...
AUTH_INCOMPLETE = (
    "Both username and password are required for authentication. Either provide both or neither."
)
