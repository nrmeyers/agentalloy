...
def extract_function_name(func_node: Node) -> str | None:
    match func_node.type:
        ...
        case cs.CppNodeType.DECLARATION | cs.CppNodeType.CONSTRUCTOR_OR_DESTRUCTOR_DECLARATION:
...
def extract_class_name_from_out_of_class_method(func_node: Node) -> str | None:
    ...
    has_nested_qualified = any(
        child.type == cs.CppNodeType.QUALIFIED_IDENTIFIER for child in qualified_id.children
    )
