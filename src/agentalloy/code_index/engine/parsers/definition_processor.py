...
class DefinitionProcessor(
    ...
    def process_file(
        ...
        logger.info(ls.DEF_PARSING_AST.format(language=language, path=relative_path_str))
    ...
    def _add_dependency(
        ...
        self.ingestor.ensure_node_batch(cs.NodeLabel.EXTERNAL_PACKAGE, {cs.KEY_NAME: dep_name})
