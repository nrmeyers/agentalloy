...
class JsTypeInferenceEngine:
    ...
    def build_local_variable_type_map(self, caller_node: ASTNode, module_qn: str) -> dict[str, str]:
    ...
    def _infer_js_variable_type_from_value(self, value_node: ASTNode, module_qn: str) -> str | None:
    ...
    def _infer_js_method_return_type(self, method_call: str, module_qn: str) -> str | None:
        ...
        class_qn = self._resolve_js_class_name(class_name, module_qn)
        if not class_qn:
            logger.debug(ls.JS_CLASS_RESOLVE_FAILED, class_name=class_name, module_qn=module_qn)
            return None
        ...
        logger.debug(ls.JS_RETURN_ANALYZED, method_qn=method_qn, return_type=return_type)
        return return_type
    ...
    def _analyze_return_statements(self, method_node: ASTNode, method_qn: str) -> str | None:
