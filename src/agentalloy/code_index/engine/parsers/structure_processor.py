...
class StructureProcessor:
    ...
    def identify_structure(self) -> None:
        ...
        for root in sorted(directories):
            ...
            if is_package:
                package_qn = cs.SEPARATOR_DOT.join([self.project_name] + list(relative_root.parts))
    ...
    def process_generic_file(self, file_path: Path, file_name: str) -> None:
        ...
        parent_identifier = self._get_parent_identifier(relative_root, parent_container_qn)
